...
dir_path = os.getcwd() + "/ArquivosPY/MQTTLocal" # obtém o caminho do dirétorio de trabalho atual do python, e aponta para uma pasta específica dele para armazenamento dos txt's
print(dir_path)
